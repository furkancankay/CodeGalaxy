...
<div class="auth-wrap">
    ...
    <div class="card glass">
        ...
        <form method="post" class="form" autocomplete="off">
            ...
            <input type="text" id="display_name" name="display_name" placeholder="e.g. Captain Ali" maxlength="80" required>
    ...
    <p class="foot-note">Made for young space explorers • <?= e(APP_NAME) ?></p>
</div>
